...
@section('mainBody')
        ...
        <div class="divForm">
            ...
            Geneology
                    ...
                    <fieldset>
            			...
            			{{ Form::open(array('url' => 'admin/Network/Geneology','id' => 'formMaster','method' => 'POST')) }}

            	            {{ Form::label('irid', 'Enter Member ID to display geneology:') }} 
            	         
            		          {{ Form::text('irid',null,array('Required' => true)) }}

            		          {{ Form::button('Recalculate Balances',array('id' => 'btnRecalculate','style'=>'margin-left: 330px;')) }}
                    ...
                    <div id="ctl00_mainBody_divTree" style="float:left;">
                    @if(isset($bTreedata))

                    	@if($bTreedata['rootID'] != '')
                    	<a href=" {{ $bTreedata["rootID"] }}">Move up the tree: {{ $bTreedata['rootName'] }}(Membership ID: {{ $bTreedata['rootID'] }})</a>
                    	@endif
                    	
                    	<div id="treeTableDiv" style="overflow: hidden; height: 224px; border: 3px none rgb(0, 0, 0); position: relative; width: 634px;margin-left: 20px;"> 
                    			...
                    			<span style="white-space: nowrap; display: inline-block;">
                    				<table class="networkTable">
                    					<tbody>
                    						...
                    						<br>
                    						IR ID:
                    						<a class="networkLink" href="{{ $bTreedata["parent"][0]->display_irid }}">
                    				...
                    				<span style="white-space: nowrap; display: inline-block;">
                    					<table class="networkTable">
                    						<tbody>
                    							...
                    							<br>
                    							IR ID:							
                    							<a class="networkLink" href="{{ $bTreedata["lChild"][0]->display_irid }}">
                    			...
                    			<span style="white-space: nowrap; display: inline-block;">
                    				<table class="networkTable">
                    					<tbody>
                    						...
                    						<br>
                    						IR ID:
                    						<a class="networkLink" href="{{ $bTreedata["llChild"][0]->display_irid }}">
                    			...
                    			<span style="white-space: nowrap; display: inline-block;">
                    				<table class="networkTable">
                    					<tbody>
                    						...
                    						<br>
                    						IR ID:
                    						<a class="networkLink" href="{{ $bTreedata["lrChild"][0]->display_irid }}">
                    			...
                    			<span style="white-space: nowrap; display: inline-block;">
                    				<table class="networkTable">
                    					<tbody>
                    						...
                    						<br>
                    						IR ID:
                    						<a class="networkLink" href="{{ $bTreedata["rChild"][0]->display_irid }}">
                    			...
                    			<span style="white-space: nowrap; display: inline-block;">
                    				<table class="networkTable">
                    					<tbody>
                    						...
                    						<br>
                    						IR ID:
                    						<a class="networkLink" href="{{ $bTreedata["rlChild"][0]->display_irid }}">
                    			...
                    			<span style="white-space: nowrap; display: inline-block;">
                    				<table class="networkTable">
                    					<tbody>
                    						...
                    						<br>
                    						IR ID:
                    						<a class="networkLink" href="{{ $bTreedata["rrChild"][0]->display_irid }}">
    ...
    <div>
    	<table>
    	<tbody><tr>
    	<td class="networkDetailsCellDummy" style="border: 1px solid #ddd;">Dummy Policy</td>
    	</tr>
    	<tr>
    	<td class="networkDetailsCellNew">New Policy</td>
    	</tr>
    	<tr>
    	<td class="networkDetailsCellPending">Pending Policy</td>
    	</tr>
    	<tr>
    	<td class="networkDetailsCell">30,000 Policy</td>
    	</tr>
    	<tr>
    	<td class="networkDetailsCellHalf">15,000 Policy</td>
    	</tr>
    	<tr>
    	<td class="networkDetailsCellQuarter">7,500 Policy</td>
    	</tr>
